...
app.use("/orders", require("./routes/order-updated")) // Updated order route
...
app.use("/stats", require("./routes/stats")) // New stats route
app.use("/withdrawal", require("./routes/withdrawal")) // New withdrawal route
